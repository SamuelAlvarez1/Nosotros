    ...
    >
      ...
      <div className="max-w-xl w-full text-center relative z-10">
        ...
        >
          ...
          <motion.button
            onClick={onYes}
            className="w-full max-w-md px-10 py-7 sm:py-8 md:py-10 text-2xl sm:text-3xl md:text-4xl font-bold text-white bg-gradient-to-r from-rose-500 to-pink-500 rounded-3xl shadow-xl transition-colors duration-300 hover:from-rose-600 hover:to-pink-600"
          ...
          >
            <button
              ...
              className="px-10 py-5 sm:py-6 text-lg sm:text-xl font-medium text-gray-500 bg-gray-200/80 rounded-2xl cursor-not-allowed opacity-50 transition-all duration-300"
              disabled
            >
              {config.noButtonText}
            </button>
